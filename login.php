...
<body style="background-color: limegreen;">
            ...
            <div class="col-md-12 text-center">
                <h2 class="display-3"> <strong>Medicine Dosage Tracking and Notification System</strong></h2>
            </div>
<div class="container">
            <div class="col-md-7 p-5">
                <form action="login.php" method="POST" autocomplete="off">
                    <h4  class="text-uppercase"><strong>Register Here</strong></h4>
            ...
            <input type="text" class="form-control" name="fullname" id="fullname" placeholder="">
                   ...
                   <strong> <input type="submit" value="Register" class="form-control btn btn-primary my-3" name="registerSubmit"></strong>
        ...
        <div class="row mt-5">
            <div class="col-md-5 p-5">
                <form class="" action="login.php" method="post" autocomplete="off">
                    <h4 class="text-uppercase"><strong>Login Here</strong></h4>
